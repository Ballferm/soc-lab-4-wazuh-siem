...
![Network topology diagram](screenshots/01-topology-diagram.png)
*Network/topology diagram showing the four VMs and the manager-agent relationships.*
...
![VM specs](screenshots/02-vm-specs.png)
...
![Wazuh services running](screenshots/03-wazuh-services-running.png)
![Wazuh dashboard login](screenshots/04-wazuh-dashboard-login.png)
...
![Agents active dashboard](screenshots/05-agents-active-dashboard.png)
...
![ossec.conf eventchannel config](screenshots/06-ossec-conf-eventchannel.png)
...
![Rule 60122 failed logon with MITRE mapping](screenshots/07-rule-60122-failed-logon-mitre.png)
...
![Sysmon installation](screenshots/08-sysmon-installation.png)
...
![Sysmon events flowing into Wazuh](screenshots/09-sysmon-events-flowing.png)
...
![Rule 92057 encoded PowerShell alert](screenshots/10-rule-92057-encoded-powershell-alert.png)
![Command line field detail](screenshots/11-commandline-field-detail.png)
...
![Decoded field discovery in raw event JSON](screenshots/12-decoded-field-discovery.png)
*The raw event JSON that revealed the real field structure.*

![Custom rule first draft](screenshots/13-custom-rule-first-draft.png)
*The original (buggy) rule.*
...
![Custom rule final with if_group](screenshots/14-custom-rule-final-with-ifgroup.png)
*The corrected rule.*
